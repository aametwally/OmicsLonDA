...
setwd("C:/Users/ametwall/Box/Ahmed Metwally's Files/Stanford/OmicsLonDA_dev/")
...
for(i in 1:n)
{
  ...
  middlediff_1 = sim_portion(nsubj = 20, corcoef = 0.4, long.formula = "10*(time<=100) + (10+(time-100))*(time>100&time<=150) + (10 + (200-time))*(time>150&time<=200) + 10*(time>200)")
  middlediff_2 = sim_portion(nsubj = 20, corcoef = 0.4, long.formula = "10")
  ...
  latediff_1 = sim_portion(nsubj = 20, corcoef = 0.4, long.formula = "10*(time<=150) + (10+(time-150))*(time>150&time<=200) + (10 + (250-time))*(time>200&time<=250) + 10*(time>250)")
  latediff_2 = sim_portion(nsubj = 20, corcoef = 0.4, long.formula = "10")
  ...
  verylatediff_1 = diff_1 = sim_portion(nsubj = 20, corcoef = 0.4, long.formula = "10*(time<=200) + (10+(time-200))*(time>200&time<=250) + (10 + (300-time))*(time>250&time<=300) + 10*(time>300)")
  verylatediff_2 = sim_portion(nsubj = 20, corcoef = 0.4, long.formula = "10")
...
###############################################
save(earlydiff_simulatedDataset_norm, file = "simulatedDataset_earlydiff_OmicsLonDA_1000.RData")
save(middlediff_simulatedDataset_norm, file = "simulatedDataset_middlediff_OmicsLonDA_1000.RData")
save(latediff_simulatedDataset_norm, file = "simulatedDataset_latediff_OmicsLonDA_1000.RData")
save(verylatediff_simulatedDataset_norm, file = "simulatedDataset_verylatediff_OmicsLonDA_1000.RData")
save(nondiff_simulatedDataset_norm, file = "simulatedDataset_nondiff_OmicsLonDA_1000.RData")
...
jpeg("omicslonda_simulation_middlediff_1_normalized.jpg", res = 300, height = 10, width = 15, units = 'cm')
...
load("simulatedDataset_earlydiff_OmicsLonDA_1000.RData", envir = parent.frame(), verbose = FALSE)
load("simulatedDataset_middlediff_OmicsLonDA_1000.RData", envir = parent.frame(), verbose = FALSE)
load("simulatedDataset_latediff_OmicsLonDA_1000.RData", envir = parent.frame(), verbose = FALSE)
load("simulatedDataset_verylatediff_OmicsLonDA_1000.RData", envir = parent.frame(), verbose = FALSE)
load("simulatedDataset_nondiff_OmicsLonDA_1000.RData", envir = parent.frame(), verbose = FALSE)
...
###############################################
#############   egde: global differentiation
###############################################

data = middlediff_simulatedDataset_norm
dt = data[[1]]
time <- dt$Time
group <- dt$Group
indv <- dt$Subject
...
for(i in 1:length(data)){
  countDf = rbind(countDf, data[[i]]$normalizedCount)
}
dim(countDf)

edge_obj <- build_study(data = as.matrix(countDf), grp = group, ind = indv, tme = time, sampling = "timecourse")
full_model <- fullModel(edge_obj)
null_model <- nullModel(edge_obj)


ef_obj <- fit_models(edge_obj, stat.type = "lrt")
betaCoef(ef_obj)


de_lrt <- lrt(edge_obj, nullDistn = "bootstrap", bs.its = 1000, pi0=1)
summary(de_lrt)

de_lrt <- lrt(edge_obj, nullDistn = "normal", pi0=1)
summary(de_lrt)



qval_obj <- qvalueObj(de_lrt)
names(qval_obj)
hist(qval_obj)
...
fdr.level <- 0.05
sigFeature <- qvals < fdr.level
sum(sigFeature)




globalTesting_edge = function (data){
  sig_df_unnorm_TimeGroup = vector()
  sig_df_norm_TimeGroup = vector()
  ...
  countDf = data.frame()
  countDf_normalized = data.frame()
  for(i in 1:length(data)){
    countDf = rbind(countDf, data[[i]]$Count)
    countDf_normalized = rbind(countDf_normalized, data[[i]]$normalizedCount)
  }

  
  edge_obj <- build_study(data = as.matrix(countDf), grp = group, ind = indv, tme = time, sampling = "timecourse")
  edge_obj_normalized <- build_study(data = as.matrix(countDf_normalized), grp = group, ind = indv, tme = time, sampling = "timecourse")
  
  de_lrt <- lrt(edge_obj, nullDistn = "bootstrap", bs.its = 1000, pi0=1)
  de_lrt_normalized <- lrt(edge_obj_normalized, nullDistn = "bootstrap", bs.its = 1000, pi0=1)
  ...
  qval_obj_normalized <- qvalueObj(de_lrt_normalized)
  qvals_normalized <- qval_obj_normalized$qvalues
  pvals_normalized <- qval_obj_normalized$pvalues

  
  
  fdr.level <- 0.05
  sigFeature_qvalue <- qvals < fdr.level
  sigFeature_pvalue <- pvals < fdr.level
  
  sigFeature_qvalue_normalized <- qvals_normalized < fdr.level
  sigFeature_pvalue_normalized <- pvals_normalized < fdr.level
  
  return(list(sigFeature_qvalue = sum(sigFeature_qvalue), sigFeature_pvalue = sum(sigFeature_pvalue),
              sigFeature_qvalue_normalized = sum(sigFeature_qvalue_normalized), sigFeature_pvalue_normalized = sum(sigFeature_pvalue_normalized)))
}


globalTesting_edge_earlydiff = globalTesting_edge(earlydiff_simulatedDataset_norm)
globalTesting_edge_middlediff = globalTesting_edge(middlediff_simulatedDataset_norm)
globalTesting_edge_latediff = globalTesting_edge(latediff_simulatedDataset_norm)
globalTesting_edge_verylatediff = globalTesting_edge(verylatediff_simulatedDataset_norm)
globalTesting_edge_nondiff = globalTesting_edge(nondiff_simulatedDataset_norm)
...
dim(earlydiff_simulatedDataset_norm[[1]])
...
output.omicslonda_earlydiff_1 = omicslonda(formula = normalizedCount ~ Time, 
                                           df = earlydiff_simulatedDataset_norm[[1]], n.perm = 100, 
                                      fit.method = "ssgaussian", points = points,
                                      text = "sim_f1", parall = FALSE, pvalue.threshold = 0.05,
                                      adjust.method = "BH", col = c("blue", "green"),
                                      prefix = "OmicsLonDA_clr_earlydiff_f1_visualization_final_BH", 
                                      ylabel = "CLR-NormalizedCount",
                                      DrawTestStatDist = FALSE, time.unit = "days")


output.omicslonda_earlydiff_1 = omicslonda(formula = normalizedCount ~ Time, df = earlydiff_simulatedDataset_norm[[1]], n.perm = 100, 
                                           fit.method = "ssgaussian", points = points,
                                           text = "sim_f1", parall = FALSE, pvalue.threshold = 0.05,
                                           adjust.method = "qvalue", col = c("blue", "green"),
                                           prefix = "OmicsLonDA_clr_earlydiff_f1_visualization_final_qvalue", 
                                           ylabel = "CLR-NormalizedCount",
                                           DrawTestStatDist = FALSE, time.unit = "days")
...
evaluation_summary_earlydiff_norm = automateEval_OmicsLonDA(data = earlydiff_simulatedDataset_norm, n.perm = 1000, points = points,
                                                           pvalue_threshold = 0.05, prefix = "evaluate_omicslonda_earlydiff_normalized_ordinary",
                                                           pattern = "earlydiff")

evaluation_summary_middlediff_norm = automateEval_OmicsLonDA(data = middlediff_simulatedDataset_norm, n.perm = 1000, points = points,
                                                             pvalue_threshold = 0.05, prefix = "evaluate_middlediff_omicslonda_normalized_ordinary",
                                                             pattern = "middlediff")

evaluation_summary_latediff_norm = automateEval_OmicsLonDA(data = latediff_simulatedDataset_norm, n.perm = 1000, points = points,
                                                                   pvalue_threshold = 0.05, prefix = "evaluate_omicslonda_latediff_normalized_ordinary",
                                                                   pattern = "latediff")


evaluation_summary_verylatediff_norm = automateEval_OmicsLonDA(data = verylatediff_simulatedDataset_norm, n.perm = 1000, points = points,
                                                                   pvalue_threshold = 0.05, prefix = "evaluate_omicslonda_verylatediff_normalized_ordinary",
                                                                   pattern = "verylatediff")

evaluation_summary_nondiff_norm = automateEval_OmicsLonDA(data = nondiff_simulatedDataset_norm, n.perm = 1000, points = points,
                                                                   pvalue_threshold = 0.05, prefix = "evaluate_omicslonda_nondiff_normalized_ordinary",
                                                                   pattern = "nondiff")
...
source("C:/Users/ametwall/Box/Ahmed Metwally's Files/Stanford/MetaLonDA_dev/v1.1.5/MetaLonDA/R/Metalonda.R")
source("C:/Users/ametwall/Box/Ahmed Metwally's Files/Stanford/MetaLonDA_dev/v1.1.5/MetaLonDA/R/Visualization.R")
source("C:/Users/ametwall/Box/Ahmed Metwally's Files/Stanford/MetaLonDA_dev/v1.1.5/MetaLonDA/R/Permutation.R")
source("C:/Users/ametwall/Box/Ahmed Metwally's Files/Stanford/MetaLonDA_dev/v1.1.5/MetaLonDA/R/CurveFitting.R")
source("C:/Users/ametwall/Box/Ahmed Metwally's Files/Stanford/MetaLonDA_dev/v1.1.5/MetaLonDA/R/Normalization.R")
                                   ...
                                   pattern = "NNN")
{
  ...
  for(i in 1:length(data))
  {
    ...
    metalondaResults[[i]] = metalonda(Count = data[[i]]$normalizedCount, 
                                    Time = data[[i]]$Time, 
                                    Group = data[[i]]$Group,
                                    ID = data[[i]]$Subject, 
                                    n.perm = n.perm, fit.method = "lowess", points = points,
...
points = seq(1, 500, length.out = 500)
evaluation_summary_earlydiff_norm = automateEval_MetaLonDA(data = earlydiff_simulatedDataset_norm, n.perm = 500, points = points,
                                                           pvalue_threshold = 0.05, 
                                                           prefix = "evaluate_metalonda_earlydiff_normalized_lowess_1000",
                                                           pattern = "earlydiff")


evaluation_summary_middlediff_norm_metalonda = automateEval_MetaLonDA(data = middlediff_simulatedDataset_norm, n.perm = 500, points = points,
                                                           pvalue_threshold = 0.05, 
                                                           prefix = "evaluate_metalonda_middlediff_normalized_lowess_1000",
                                                           pattern = "middlediff")


evaluation_summary_latediff_norm_metalonda = automateEval_MetaLonDA(data = latediff_simulatedDataset_norm, n.perm = 500, points = points,
                                                           pvalue_threshold = 0.05, 
                                                           prefix = "evaluate_metalonda_latediff_normalized_lowess_1000",
                                                           pattern = "latediff")


evaluation_summary_verylatediff_norm_metalonda = automateEval_MetaLonDA(data = verylatediff_simulatedDataset_norm, n.perm = 500, points = points,
                                                           pvalue_threshold = 0.05, 
                                                           prefix = "evaluate_metalonda_verylatediff_normalized_lowess_1000",
                                                           pattern = "verylatediff")


evaluation_summary_nondiff_norm_metalonda = automateEval_MetaLonDA(data = nondiff_simulatedDataset_norm, n.perm = 500, points = points,
                                                           pvalue_threshold = 0.05, 
                                                           prefix = "evaluate_metalonda_nondiff_normalized_lowess_1000",
                                                           pattern = "nondiff")
...
### Test unnorlamized count
automateEval_MetaLonDA_raw = function(data = data, n.perm = 100, points = points, pvalue_threshold = 0.05, prefix = "MMM",
                                  pattern = "NNN")
{
  metalondaResults = list()
  for(i in 1:length(data))
  {
    ...
    metalondaResults[[i]] = metalonda(Count = data[[i]]$Count, 
                                      Time = data[[i]]$Time, 
                                      Group = data[[i]]$Group,
                                      ID = data[[i]]$Subject, 
                                      n.perm = n.perm, fit.method = "lowess", points = points,
...
points = seq(1, 500, length.out = 500)
evaluation_summary_earlydiff_metalonda = automateEval_MetaLonDA_raw(data = earlydiff_simulatedDataset_norm, n.perm = 500, points = points,
                                                           pvalue_threshold = 0.05, 
                                                           prefix = "evaluate_metalonda_earlydiff_lowess_1000",
                                                           pattern = "earlydiff")


evaluation_summary_middledif_metalonda = automateEval_MetaLonDA_raw(data = middlediff_simulatedDataset_norm, n.perm = 500, points = points,
                                                                      pvalue_threshold = 0.05, 
                                                                      prefix = "evaluate_metalonda_middlediff_lowess_1000",
                                                                      pattern = "middlediff")


evaluation_summary_latediff_metalonda = automateEval_MetaLonDA_raw(data = latediff_simulatedDataset_norm, n.perm = 500, points = points,
                                                                    pvalue_threshold = 0.05, 
                                                                    prefix = "evaluate_metalonda_latediff_lowess_1000",
                                                                    pattern = "latediff")


evaluation_summary_verylatediff_metalonda = automateEval_MetaLonDA_raw(data = verylatediff_simulatedDataset_norm, n.perm = 500, points = points,
                                                                        pvalue_threshold = 0.05, 
                                                                        prefix = "evaluate_metalonda_verylatediff_lowess_1000",
                                                                        pattern = "verylatediff")


evaluation_summary_nondiff_metalonda = automateEval_MetaLonDA_raw(data = nondiff_simulatedDataset_norm, n.perm = 500, points = points,
                                                                   pvalue_threshold = 0.05, 
                                                                   prefix = "evaluate_metalonda_nondiff_lowess_1000",
                                                                   pattern = "nondiff")
...
# #The ExpressionSet class is a widely used object in Bioconductor a
# slotNames(edge_obj)
...
# de_lrt <- lrt(edge_obj, nullDistn = "normal")
# summary(de_lrt)
# 
# 
# ## With bootstrap
# de_lrt <- lrt(edge_obj, nullDistn = "bootstrap", bs.its = 1000)
# 
# summary(de_lrt)
# 
# 
